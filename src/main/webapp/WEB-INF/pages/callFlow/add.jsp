    ...
    <div class="layui-row layui-col-space10">
        <div class="flow-wrap layui-col-md12">
            <div class="layui-form-item" style="margin-bottom: -15px!important;">
                <div class="flow-head">
                    <h3>流程创建</h3>
                    <button type="button" class="layui-btn fr btn-bg1" style="margin-top: 6px;margin-right: 20px;" onclick="test()">保存</button>
                    <button type="button" class="layui-btn fr btn-bg1" style="margin-top: 6px;margin-right: 10px;" onclick="closeFlow()">关闭</button>
                </div>
                <div class="flow-title layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text"id="flowName" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label wd120">
                        ...
                        <div class="layui-input-inline">
                            <input type="text"id="flowContent" class="layui-input" maxlength="50" placeholder="请输入50字以内的描述">
                        </div>
                    </div>
                </div>
            </div>
