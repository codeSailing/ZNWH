    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (sta != undefined && sta == 3) {
                ...
                startPlay(1, callContent,callback);
                ...
                // var callContent = data.callContent;
                if (callContent == null || callContent == "" || callContent == "[]") {
                    return;
                }
...
// 开始语音播报
function startPlay(speakId, text,callback) {

    text = text.replace(/<br >/g, "");
    XFAsr.TDStartTTS(speakId, text);
    if(callback!=null){
        setTimeout(function () {
            callback();
        },5000)
