        ...
        layui.use(['table','form','element','laydate'], function () {
            ...
            table.render({
                ...
                , cols: [[ //标题栏
                    ...
                    , {field: 'updateTime', title: '更新时间',templet:'<div>{{layui.laytpl.toDateString(d.updateTime,"yyyy-MM-dd HH:mm")}}</div>', width: 180}
            ...
            table.on('tool(contentList)', function (obj) {
                ...
                if (layEvent == "delete") { //删除
                    ...
                    window.location.href=context + "/callFlow/updateFlow.do?id="+data.id;
                } else if (layEvent == "look") {
                    window.location.href=context + "/callFlow/detail.do?id="+data.id;
                }
            });
