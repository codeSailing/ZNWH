                ...
                $$(go.Palette, "myPaletteDiv",  // 必须命名或引用DIV HTML元素
                    {
                        ...
                        model: new go.GraphLinksModel([  // 指定调色板的内容
                            ...
                            {text: "开始",flag:"1",figure: "RoundedRectangle",fill:"#66C99C",start:"1",id:"",answer:"",defaultRef:"",exceptionRef:"",content:"",startFlow:""},
                            ...
                            {text: "结束",flag:"1",fill:"red", figure: "RoundedRectangle",start:"-1",id:"",answer:"",defaultRef:"",exceptionRef:"",content:"",endFlow:""}
                        ], [
                            // 调色板也有一个断开的链接，用户可以拖放
